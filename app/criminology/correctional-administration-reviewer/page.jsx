...
export default function CorrectionalAdministrationPage() {
  return (
    <div className="min-h-screen py-10">
      ...
      <BreadcrumbSchema items={[{"url":"/","name":"Home"},{"url":"/criminology","name":"Criminology"},{"url":"/criminology/correctional-administration-reviewer","name":"Correctional Administration Reviewer"}]} />
