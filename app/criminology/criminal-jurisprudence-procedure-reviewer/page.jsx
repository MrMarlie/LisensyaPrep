...
export default function CriminalJurisprudencePage() {
  return (
    <div className="min-h-screen py-10">
      ...
      <BreadcrumbSchema items={[{"url":"/","name":"Home"},{"url":"/criminology","name":"Criminology"},{"url":"/criminology/criminal-jurisprudence-procedure-reviewer","name":"Criminal Jurisprudence Reviewer"}]} />
