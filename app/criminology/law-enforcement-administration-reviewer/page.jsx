...
export default function LawEnforcementAdminPage() {
  return (
    <div className="min-h-screen py-10">
      ...
      <BreadcrumbSchema items={[{"url":"/","name":"Home"},{"url":"/criminology","name":"Criminology"},{"url":"/criminology/law-enforcement-administration-reviewer","name":"Law Enforcement Administration Reviewer"}]} />
