...
export default function PhysiologicalAdaptationNclexPage() {
  return (
    <div className="min-h-screen py-10">
      ...
      <BreadcrumbSchema items={[{"url":"/","name":"Home"},{"url":"/nursing","name":"Nursing"},{"url":"/nursing/physiological-adaptation-nclex-reviewer","name":"Physiological Adaptation Reviewer"}]} />
