...
export default function UrinalysisBodyFluidsReviewerPage() {
  return (
    <div className="min-h-screen py-10">
      ...
      <BreadcrumbSchema items={[{"url":"/","name":"Home"},{"url":"/medical-technology","name":"Medical Technology"},{"url":"/medical-technology/urinalysis-body-fluids-reviewer","name":"Urinalysis and Body Fluids Reviewer"}]} />
