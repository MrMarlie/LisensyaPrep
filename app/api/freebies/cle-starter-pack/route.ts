...
const PDF_VIEW_URL =
  'https://drive.google.com/file/d/1HX5M8abNw79i6MLZ3GldWv4Dkuu3rcKI/view?usp=sharing';
const PDF_DOWNLOAD_URL =
  'https://drive.google.com/uc?export=download&id=1HX5M8abNw79i6MLZ3GldWv4Dkuu3rcKI';
  ...
  try {
    ...
    try {
      await mailer().sendMail({
        ...
        to: cleanEmail,
        subject: '🎁 Your CLE Criminology Starter Pack is here!',
        html: `
          <div style="font-family:Arial,sans-serif;max-width:560px;margin:0 auto;background:#080d1b;border-radius:12px;overflow:hidden;">
            <div style="background:#080d1b;padding:24px 32px;text-align:center;border-bottom:1px solid #1e293b;">
              ...
              <p style="color:#64748b;font-size:13px;margin:4px 0 0;">Your Criminology Licensure Exam preparation partner</p>
            </div>
            <div style="padding:32px;color:#d1d5db;">
              <h1 style="color:#ffffff;font-size:22px;margin:0 0 8px;">Hi ${cleanName},</h1>
              <p style="margin:0 0 20px;">Salamat for joining LisensyaPrep! Your free CLE Criminology Starter Pack is ready below.</p>

              <div style="background:#0f1629;border:2px solid #facc15;border-radius:12px;padding:24px;text-align:center;margin:0 0 24px;">
                <p style="color:#facc15;font-weight:700;font-size:16px;margin:0 0 16px;">📥 CLE Criminology Starter Pack 2026</p>
                <a href="${PDF_VIEW_URL}"
              ...
              <ul style="padding-left:20px;margin:0 0 20px;line-height:2;">
                <li>30 CLE questions with full rationales</li>
                <li>All 6 subjects: Criminal Jurisprudence, Law Enforcement Administration, Criminalistics, Correctional Administration, Juvenile Delinquency, Criminal Sociology &amp; Ethics</li>
                <li>Built for the 2026 PRC Board of Criminology coverage</li>
              ...
              <div style="background:#1a2035;border:1px solid #facc1540;border-radius:10px;padding:16px;margin:0 0 24px;">
                <p style="color:#facc15;font-weight:700;margin:0 0 6px;">📚 Keep reviewing free</p>
                <p style="margin:0 0 10px;font-size:13px;line-height:1.6;">Practice all 6 CLE subjects with free questions and read our deep-dive reviewers — no account required.</p>
                <a href="https://lisensyaprep.com/criminology" style="color:#facc15;font-weight:700;font-size:13px;">Start practicing at LisensyaPrep →</a>
              </div>

              <p style="margin:0 0 24px;"><strong style="color:#ffffff;">Pass it forward:</strong><br>
              Got a barkada also taking the CLE? Share the PDF with them — it&apos;s free to share!</p>

              <p style="margin:0;">Best of luck on your CLE journey,</p>
    ...
    console.error('CLE freebie signup error:', err);
