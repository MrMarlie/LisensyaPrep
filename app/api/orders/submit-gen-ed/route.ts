...
function resolveAmount(promoCode: string): number {
  if (promoCode?.trim().toUpperCase() === WAITLIST_CODE && new Date() <= WAITLIST_EXPIRY) {
    return BASE_PRICE - WAITLIST_DISCOUNT;
  }
  return BASE_PRICE;
}
...
export async function POST(req: NextRequest) {
  try {
    ...
    const { fullName, email, gcashRef, paymentDate, phone, referralSource, promoCode } = body;
    ...
    const amount = resolveAmount(promoCode || '');
    ...
    try {
      ...
      await transport.sendMail({
        ...
        subject: `🛒 New Gen Ed Order — ${orderId} — ${fullName}`,
        html: `
          <h2>New Gen Ed Mastery Order</h2>
          <p><strong>Order ID:</strong> ${orderId}</p>
          <p><strong>Product:</strong> LET Gen Ed Mastery System</p>
          <p><strong>Name:</strong> ${fullName}</p>
          <p><strong>Email:</strong> ${email}</p>
          <p><strong>GCash Ref:</strong> ${gcashRef}</p>
          <p><strong>Payment Date:</strong> ${paymentDate}</p>
          <p><strong>Amount:</strong> ₱${amount}${promoCode ? ` (promo: ${promoCode})` : ''}</p>
      ...
      await transport.sendMail({
        ...
        to: email,
        subject: '✅ Order Received — LisensyaPrep LET Gen Ed Mastery System',
        html: `
          <div style="font-family:Arial,sans-serif;max-width:560px;margin:0 auto;color:#1f2937;">
            ...
            <div style="background:#0f1629;padding:32px;border-radius:0 0 12px 12px;color:#d1d5db;">
              ...
              <div style="background:#080d1b;border-radius:10px;padding:16px;margin:20px 0;">
                ...
                <p style="margin:4px 0;">Product: LET Gen Ed Mastery System 2026</p>
              ...
              <ol style="padding-left:20px;">
                ...
                <li style="margin-bottom:8px;">You&apos;ll receive a second email with your PDF reviewer via Google Drive</li>
                <li>If there&apos;s an issue, we&apos;ll reach out within 4 hours</li>
              </ol>
              <p><strong style="color:#ffffff;">Study while you wait:</strong></p>
              <ul style="padding-left:20px;">
                <li><a href="https://lisensyaprep.com/education/general-education-reviewer" style="color:#facc15;">General Education Reviewer for LET 2026</a></li>
                <li><a href="https://lisensyaprep.com/education/let-secondary-major-english-reviewer" style="color:#facc15;">LET English Subject Reviewer</a></li>
