...
const PRODUCT = 'cse-subprof-mastery';
...
function generateOrderId() {
  ...
  return `LSN-CSESP-${Date.now()}-${rand}`;
}
  ...
  try {
    ...
    try {
      ...
      await transport.sendMail({
        ...
        subject: `🏛️ New CSE SubProf Order — ${orderId} — ${fullName}`,
        html: `
          <h2>New CSE SubProfessional Mastery Order Received</h2>
      ...
      await transport.sendMail({
        ...
        to: email,
        subject: '✅ Order Received — LisensyaPrep CSE SubProfessional Mastery System',
        html: `
          <div style="font-family:Arial,sans-serif;max-width:560px;margin:0 auto;color:#1f2937;">
            <div style="background:#080d1b;padding:24px;border-radius:12px 12px 0 0;text-align:center;">
              ...
              <p style="color:#fde68a;font-size:13px;margin:4px 0 0;">Civil Service Exam Preparation</p>
            </div>
            <div style="background:#0f1629;padding:32px;border-radius:0 0 12px 12px;color:#d1d5db;">
              ...
              <div style="background:#080d1b;border-radius:10px;padding:16px;margin:20px 0;border:1px solid #facc1540;">
                <p style="margin:0 0 8px;font-weight:700;color:#facc15;">Your Order Details</p>
                <p style="margin:4px 0;">Product: CSE SubProfessional Mastery System 2026</p>
              ...
              <ul style="padding-left:20px;">
                <li><a href="https://lisensyaprep.com/civil-service/how-to-pass-civil-service-exam" style="color:#facc15;">How to Pass the Civil Service Exam in 2026</a></li>
                <li><a href="https://lisensyaprep.com/civil-service/clerical-ability-reviewer-cse" style="color:#facc15;">Clerical Ability Reviewer for CSE SubProfessional</a></li>
                <li><a href="https://lisensyaprep.com/civil-service" style="color:#facc15;">Free CSE Practice Questions</a></li>
              </ul>

              <p style="margin-top:24px;">If you don&apos;t receive your PDF within 12 hours, reply to this email.</p>
              <p>Good luck, future public servant! 🏛️</p>
    ...
    console.error('CSE SubProf order submit error:', err);
