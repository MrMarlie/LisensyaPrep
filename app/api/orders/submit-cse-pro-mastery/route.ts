...
function generateOrderId() {
  ...
  return `LSN-CSEPR-${Date.now()}-${rand}`;
}
  ...
  try {
    ...
    try {
      ...
      await transport.sendMail({
        ...
        subject: `🏛️ New CSE Professional Order — ${orderId} — ${fullName}`,
        html: `
          <h2>New CSE Professional Mastery Order Received</h2>
      ...
      await transport.sendMail({
        ...
        to: email,
        subject: '✅ Order Received — LisensyaPrep CSE Professional Mastery System',
        html: `
          <div style="font-family:Arial,sans-serif;max-width:560px;margin:0 auto;color:#1f2937;">
            ...
            <div style="background:#0f1629;padding:32px;border-radius:0 0 12px 12px;color:#d1d5db;">
              ...
              <div style="background:#080d1b;border-radius:10px;padding:16px;margin:20px 0;border:1px solid #facc1540;">
                ...
                <p style="margin:4px 0;">Product: CSE Professional Mastery System 2026</p>
              ...
              <ul style="padding-left:20px;">
                ...
                <li><a href="https://lisensyaprep.com/civil-service/analytical-ability-reviewer-cse" style="color:#facc15;">Analytical Ability Reviewer for CSE Professional</a></li>
    ...
    console.error('CSE Pro order submit error:', err);
