  ...
  try {
    ...
    try {
      ...
      await transport.sendMail({
        ...
        subject: `⚖️ New CLE Order — ${orderId} — ${fullName}`,
        html: `
          <h2>New CLE Mastery Order Received</h2>
      ...
      await transport.sendMail({
        ...
        to: email,
        subject: '✅ Order Received — LisensyaPrep CLE Criminology Mastery System',
        html: `
          <div style="font-family:Arial,sans-serif;max-width:560px;margin:0 auto;color:#1f2937;">
            <div style="background:#080d1b;padding:24px;border-radius:12px 12px 0 0;text-align:center;">
              ...
              <p style="color:#fca5a5;font-size:13px;margin:4px 0 0;">Criminology Licensure Exam Preparation</p>
            </div>
            <div style="background:#0f1629;padding:32px;border-radius:0 0 12px 12px;color:#d1d5db;">
              ...
              <div style="background:#080d1b;border-radius:10px;padding:16px;margin:20px 0;border:1px solid #facc1540;">
                ...
                <p style="margin:4px 0;">Product: CLE Criminology Mastery System 2026</p>
              ...
              <ul style="padding-left:20px;">
                <li><a href="https://lisensyaprep.com/criminology/cle-coverage-2026" style="color:#facc15;">CLE Coverage 2026 — Complete Subject Breakdown</a></li>
                <li><a href="https://lisensyaprep.com/criminology/criminal-jurisprudence-procedure-reviewer" style="color:#facc15;">Criminal Jurisprudence and Procedure Reviewer</a></li>
                <li><a href="https://lisensyaprep.com/criminology" style="color:#facc15;">Free CLE Practice Questions</a></li>
              </ul>

              <p style="margin-top:24px;">If you don&apos;t receive your PDF within 12 hours, reply to this email.</p>
              <p>Thanks for trusting LisensyaPrep with your CLE preparation! ⚖️</p>
    ...
    console.error('CLE order submit error:', err);
