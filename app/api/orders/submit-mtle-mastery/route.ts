  ...
  try {
    ...
    try {
      ...
      await transport.sendMail({
        ...
        subject: `🧪 New MTLE Order — ${orderId} — ${fullName}`,
        html: `
          <h2>New MTLE Mastery Order Received</h2>
      ...
      await transport.sendMail({
        ...
        to: email,
        subject: '✅ Order Received — LisensyaPrep MTLE Mastery System',
        html: `
          <div style="font-family:Arial,sans-serif;max-width:560px;margin:0 auto;color:#1f2937;">
            <div style="background:#080d1b;padding:24px;border-radius:12px 12px 0 0;text-align:center;">
              ...
              <p style="color:#67e8f9;font-size:13px;margin:4px 0 0;">MTLE Preparation</p>
            </div>
            <div style="background:#0f1629;padding:32px;border-radius:0 0 12px 12px;color:#d1d5db;">
              ...
              <div style="background:#080d1b;border-radius:10px;padding:16px;margin:20px 0;border:1px solid #06b6d440;">
                <p style="margin:0 0 8px;font-weight:700;color:#06b6d4;">Your Order Details</p>
                <p style="margin:4px 0;">Product: MTLE Mastery System 2026</p>
              ...
              <ul style="padding-left:20px;">
                <li><a href="https://lisensyaprep.com/medical-technology/mtle-coverage-2026" style="color:#06b6d4;">MTLE Coverage 2026 — Complete Subject Breakdown</a></li>
                <li><a href="https://lisensyaprep.com/medical-technology/how-to-pass-mtle-board-exam" style="color:#06b6d4;">How to Pass the MTLE Board Exam</a></li>
                <li><a href="https://lisensyaprep.com/medical-technology" style="color:#06b6d4;">Free MTLE Practice Questions</a></li>
              </ul>

              <p style="margin-top:24px;">If you don&apos;t receive your PDF within 12 hours, reply to this email.</p>
              <p>Thanks for trusting LisensyaPrep with your MTLE preparation! 🧪</p>
    ...
    console.error('MTLE order submit error:', err);
