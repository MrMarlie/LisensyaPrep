  ...
  try {
    ...
    try {
      ...
      await transport.sendMail({
        ...
        subject: `🏥 New PNLE Order — ${orderId} — ${fullName}`,
        html: `
          <h2>New PNLE Mastery Order Received</h2>
      ...
      await transport.sendMail({
        ...
        to: email,
        subject: '✅ Order Received — LisensyaPrep PNLE Mastery System',
        html: `
          <div style="font-family:Arial,sans-serif;max-width:560px;margin:0 auto;color:#1f2937;">
            <div style="background:#080d1b;padding:24px;border-radius:12px 12px 0 0;text-align:center;">
              ...
              <p style="color:#f9a8d4;font-size:13px;margin:4px 0 0;">PNLE Preparation</p>
            </div>
            <div style="background:#0f1629;padding:32px;border-radius:0 0 12px 12px;color:#d1d5db;">
              ...
              <div style="background:#080d1b;border-radius:10px;padding:16px;margin:20px 0;border:1px solid #ec489940;">
                <p style="margin:0 0 8px;font-weight:700;color:#ec4899;">Your Order Details</p>
                <p style="margin:4px 0;">Product: PNLE Mastery System 2026</p>
              ...
              <ul style="padding-left:20px;">
                <li><a href="https://lisensyaprep.com/nursing/pnle-coverage-2026" style="color:#ec4899;">PNLE Coverage 2026 — Complete Topic Breakdown</a></li>
                <li><a href="https://lisensyaprep.com/nursing/pnle-3-month-study-plan" style="color:#ec4899;">PNLE 3-Month Study Plan for Self-Reviewers</a></li>
                <li><a href="https://lisensyaprep.com/nursing" style="color:#ec4899;">Free NLE Practice Questions</a></li>
              </ul>

              <p style="margin-top:24px;">If you don&apos;t receive your PDF within 12 hours, reply to this email.</p>
              <p>Thanks for trusting LisensyaPrep with your PNLE preparation! 🏥</p>
    ...
    console.error('PNLE order submit error:', err);
