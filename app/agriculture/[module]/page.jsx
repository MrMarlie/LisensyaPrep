...
export async function generateMetadata({ params }) {
  ...
  return buildMetadata({
    title: `${mod.title} — Agriculture PRC Review`,
    description: mod.description,
    path: `/agriculture/${mod.id}`,
  });
}
      ...
      <section className={`relative bg-gradient-to-b ${mod.color} py-16 overflow-hidden`}>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <nav className="flex items-center gap-2 text-sm mb-6" aria-label="Breadcrumb">
            ...
            <Link href="/agriculture" className="text-gray-500 hover:text-gray-300">Agriculture</Link>
            <span className="text-gray-700">/</span>
          ...
          <div className="flex flex-col sm:flex-row sm:items-start gap-6">
            ...
            <div>
              <p className="text-gray-400 text-sm font-semibold uppercase tracking-widest mb-1">
                Agriculture • Stage {mod.stageNumber}
              </p>
          ...
          <div className="bg-[#0f1629] border border-white/10 rounded-2xl p-6">
            ...
            <dl className="space-y-3 text-sm">
              <div className="flex justify-between">
                ...
                <dd className="text-white font-semibold">30</dd>
              </div>
              <div className="flex justify-between">
