...
export default function CheckoutPage() {
  ...
  useEffect(() => { trackEvent('checkout_page_view'); }, []);
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      trackEvent('checkout_form_submit', { orderId: data.orderId });
      router.push('/premium/let-profed-mastery/thank-you');
    } catch (err: unknown) {
    ...
    <div className="min-h-screen py-10 px-4">
      <div className="max-w-xl mx-auto">
        ...
        <div className="bg-[#0f1629] border border-white/10 rounded-2xl p-6 mb-6">
          ...
          <p className="text-white font-bold mt-1">LisensyaPrep LET ProfEd Mastery System 2026</p>
            ...
            <div className="flex-shrink-0">
              ...
              <div className="w-36 h-36 bg-white rounded-xl overflow-hidden flex items-center justify-center">
                <Image
                  ...
                  alt="GCash QR Code for Alexis Mar Mendiola"
                  width={144}
                  height={144}
        ...
        <div className="bg-[#0f1629] border border-white/10 rounded-2xl p-6 mb-6">
          ...
          <ol className="space-y-2">
            {[
              ...
              'We email you the PDF reviewer + welcome bonus',
              'You start studying',
            ].map((item, i) => (
