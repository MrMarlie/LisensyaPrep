...
export default function CseRetakeRulesStrategyPage() {
  return (
    <div className="min-h-screen py-10">
      ...
      <BreadcrumbSchema items={[{"url":"/","name":"Home"},{"url":"/civil-service","name":"Civil Service"},{"url":"/civil-service/cse-retake-rules-strategy","name":"CSE Retake Rules and Strategy"}]} />
