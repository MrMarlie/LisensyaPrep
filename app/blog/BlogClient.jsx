...
const TAG_COLORS = {
  ...
  'PRC Guides': 'bg-purple-500/10 text-purple-400',
  ...
  'Civil Service (CSE)': 'bg-teal-500/10 text-teal-400',
  'Civil Service (Filipino)': 'bg-teal-500/10 text-teal-400',
...
const CATEGORY_TAG_MAP = {
  'Board Exam Guides': ['Board Exam Guide', 'PRC Guides'],
  'Nursing': ['Nursing'],
  'NCLEX': ['NCLEX'],
  'Criminology': ['Criminology'],
  'Education': ['Education', 'Education (Filipino)'],
  'Civil Service': ['Civil Service (CSE)', 'Civil Service (Filipino)'],
