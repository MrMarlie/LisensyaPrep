...
export default function LETFilipinoReviewerPage() {
  return (
    <div className="min-h-screen py-10">
      ...
      <BreadcrumbSchema items={[{"url":"/","name":"Home"},{"url":"/education","name":"Education"},{"url":"/education/let-secondary-major-filipino-reviewer","name":"Secondary Major Filipino Reviewer"}]} />
